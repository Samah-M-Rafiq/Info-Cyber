...
- Mirai Botnet (2016): DDoS attack using vuilnerable IoT device
...
- Strong password & certification-based authentication
- Secure firmware OTA updates
- Logging & monitering of device behaviour
